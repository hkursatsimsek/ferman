...
**Sonraki görev:** F1.13 — Yerelleştirme ve erişilebilirlik temeli: tüm metinler katalogda, `BannedWordsTests` (xcstrings), VoiceOver çekirdek akış, XXL, Reduce Motion, SFX (`AVAudioSession.ambient`).
