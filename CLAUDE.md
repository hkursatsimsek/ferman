...
**Sonraki görev:** F1.7 — `RuleEditorView` / `RuleEditorModel`: birim sekmeleri, `reorderContainer` + `reorderable()`, sabit varsayılan kart, yerinde kadran, seçicilerle ekleme sheet'i, ordu geneli sayaç, `OrderPhraseFormatter`.
